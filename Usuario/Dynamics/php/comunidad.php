...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            ...
            <img class="unamescudo" id="vacio" src="../../statics/media/EscudoUNAM.jpg" alt="dos" width="80"
                height="80">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="pagRedireccion" class="nav-item"><a class="nav-link" id="pagPrincipal" href="#">Página
                            principal</a></li>
                    <li class="pagRedireccion" class="nav-item"><a class="nav-link" id="ventas" href="#!">Ventas</a>
                    </li>
                    <li class="pagRedireccion" class="nav-item"><a class="nav-link" id="objPerdidos" href="#!">Objetos
                            perdidos</a></li>
                    <li class="fotoUsuario" class="nav-item"><a class="nav-link" id="perfil" href="#!">Comunidad P6</a>
                    </li>
                </ul>
            </div>
        </div>
